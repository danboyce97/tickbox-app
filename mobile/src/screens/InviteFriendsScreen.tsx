...
export default function InviteFriendsScreen() {
    ...
    try {
      ...
      switch (method) {
        case "whatsapp":
          ...
          break;
        case "instagram":
          customMessage = "Check out TickBox! 🎫✨ The best way to keep track of all your event memories!\n\nDownload: https://apps.apple.com/gb/app/tickbox/id6753213384\n\n#TickBox #Events #Memories";
          break;
        case "twitter":
          customMessage = "Just discovered @TickBox 🎫 - the perfect app for keeping track of all my event memories! Never lose a ticket again ✨\n\nhttps://apps.apple.com/gb/app/tickbox/id6753213384\n\n#TickBox #Events";
          break;
        case "email":
  ...
  const handleCopyLink = async () => {
    const inviteLink = "https://apps.apple.com/gb/app/tickbox/id6753213384";
        ...
        <View className="px-6 mb-8">
          <TickBoxCard>
            ...
            <View className="flex-row">
              ...
              >
                <Text style={{ color: colors.textSecondary, fontSize: 14 }}>
                  apps.apple.com/gb/app/tickbox/id6753213384
                </Text>
              </View>
              <Pressable
