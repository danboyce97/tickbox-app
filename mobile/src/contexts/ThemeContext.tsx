...
export function ThemeProvider({ children }: { children: React.ReactNode }) {
  ...
  // Set initial theme based on system preference only if user exists and hasn't set one
  useEffect(() => {
    if (user && !userTheme && systemColorScheme) {
      setTheme(systemColorScheme);
    }
  }, [systemColorScheme, userTheme, setTheme, user]);
